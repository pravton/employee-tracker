      ...
      .prompt ([
        {
          ...
          validate: nameInput => {
            if(nameInput) {
                ...
                console.log(`   The name cannot be empty, Please enter a valid department name!`);
                return false;
            }
          }
        }
      ...
      .prompt([
        {
          type: 'list',
          name: 'department',
          message: 'Please choose a department to delete (Please note that the values of the related columns will be null)',
          choices: function() {
            return db.promise()
            .query(`SELECT * FROM department`)
            .then(([rows, fields]) => {
